...
- Native **WebSocket** server for pushing live captions to the frontend
...
- Slice audio into chunks and send them to `backend/` for transcription/translation
...
- Broadcast live captions / status / summaries to `frontend/` over WebSocket
